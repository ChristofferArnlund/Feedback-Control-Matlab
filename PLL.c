...
#define SYSCTL_RCC_XTAL_M       0x000007C0  // Crystal Value - pg 256
...
void PLL_Init(uint32_t freq){
  ...
  SYSCTL->RCC2 |= SYSCTL_RCC2_USERCC2; // Use RCC2 (tm4c123gh6pm.pdf, pg 260)
  ...
  SYSCTL->RCC2 = (SYSCTL->RCC2 & ~0x1FC00000) // clear SYSDIV2 (pg. 261),
                  + (freq<<22);      // configure for 80 MHz clock (Table 5-6, pg. 224)
